...
A novel surrogate model called Rashomon Tree (Rtree) to inhibit the Rashomon effect of MLP. Our paper is currently under review by IEEE Transactions on Computational Social Systems.
